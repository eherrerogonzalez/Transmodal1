...
const PLATFORMS = [
  ...
  },
  {
    ...
    description: 'WMS, TMS, pricing, contratos y rentabilidad',
    icon: Building2,
  ...
  },
  {
    ...
    description: 'Tareas de picking, ubicación y montacargas',
    icon: User,
  ...
  },
  {
    ...
    description: 'Viajes asignados, rutas y seguimiento GPS',
    icon: Truck,
